...
${OBJECTDIR}/src/extras.o: src/extras.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/extras.o src/extras.cpp

${OBJECTDIR}/src/Recorder.o: src/Recorder.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Recorder.o src/Recorder.cpp

${OBJECTDIR}/src/Device.o: src/Device.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Device.o src/Device.cpp
